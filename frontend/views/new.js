...
function New({}) {
    return (<Default>
            ...
            <form action="/recipes" method='POST'>
                ...
                <input type="int" name='prepTime' id='prepTime' required/>
                ...
                <input type="text" name="image" id="image" accept="image/*" required/>
                <label htmlFor='ingredients'>Ingredients</label>
                <input type="text" name='ingredients' id='ingredients' placeholder='Ingredients...' required/>
                <label htmlFor='instructions'>Instructions</label>
                <input type="text" name='instructions' id='instructions' placeholder='List Instructioins...' required/>
                    <br />
